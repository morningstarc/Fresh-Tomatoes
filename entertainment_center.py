...
gatsby = movie.Movie("The Great Gatsby",
                     "A writer and wall street trader, Nick, finds himself drawn to the past and"
                     " lifestyle of his millionaire neighbor, Jay Gatsby.",
                     "great_gatsby.jpg",
                     "https://youtu.be/sN183rJltNM")

body_of_lies = movie.Movie("Body of Lies",
                           "A CIA agent on the ground in Jordan hunts down a powerful terrorist leader"
                           " while being caught between the unclear intentions of his American supervisors"
